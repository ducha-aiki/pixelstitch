...
from pixelstitch.COTR.COTR.cameras.capture import crop_center_max_np, pad_to_square_np
...
def cotr_patch_flow_exhaustive(model, patches_a, patches_b):
    def one_pass(model, img_a, img_b):
        ...
        img_a = imresize(img_a, (MAX_SIZE, MAX_SIZE), anti_aliasing=True)
        img_b = imresize(img_b, (MAX_SIZE, MAX_SIZE), anti_aliasing=True)
