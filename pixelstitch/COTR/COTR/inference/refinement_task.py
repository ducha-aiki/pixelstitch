...
from pixelstitch.COTR.COTR.inference.inference_helper import BASE_ZOOM, THRESHOLD_PIXELS_RELATIVE, get_patch_centered_at, two_images_side_by_side, find_prediction_loop
from pixelstitch.COTR.COTR.utils import debug_utils, utils
from pixelstitch.COTR.COTR.utils.constants import MAX_SIZE
from pixelstitch.COTR.COTR.utils.utils import ImagePatch
...
class RefinementTask():
    ...
    def get_task(self):
        ...
        img_from = imresize(img_from, (MAX_SIZE, MAX_SIZE),anti_aliasing=True)#interp='bilinear')
        img_to = imresize(img_to, (MAX_SIZE, MAX_SIZE), anti_aliasing=True)# interp='bilinear')
