...
def main(opt):
    ...
    img_a = imageio.imread('/Users/oldufo/dev/new-wxbs-ft/WxBS/WGABS/petrzin/01.png')#'./sample_data/imgs/21526113_4379776807.jpg')
    img_b = imageio.imread('/Users/oldufo/dev/new-wxbs-ft/WxBS/WGABS/petrzin/02.png')# e_data/imgs/21126421_4537535153.jpg')
    ...
    pts = np.loadtxt('/Users/oldufo/dev/new-wxbs-ft/WxBS/WGABS/petrzin/corrs.txt') 
    kp_a = pts[:,:2]
    kp_b = pts[:,2:]
    if opt.faster_infer:
